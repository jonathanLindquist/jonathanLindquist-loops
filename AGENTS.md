...
Execution plan Markdown files live under stable paths in `docs/plans/`, for example `docs/plans/JL-0001-initialize-project-workflow.md`. Do not use lane-named status folders for new plans; old `docs/plans/Backlog/`, `docs/plans/In Progress/`, and `docs/plans/Completed/` folders are legacy.
