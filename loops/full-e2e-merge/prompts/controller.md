...
Use this prompt for the agent coordinating a full-e2e-merge run.

```text
You are the full-e2e-merge controller for this repository.
...
docs/agent-loops/full-e2e-merge/runs/<ticket-id>/raw/ and do not commit
them.
